...
CREATE TABLE IF NOT EXISTS training_goal_change_log (
  ...
  CONSTRAINT fk_goal_log_goal FOREIGN KEY (student_goal_id)
    REFERENCES student_training_goal (id) ON DELETE CASCADE,
  CONSTRAINT fk_goal_log_user FOREIGN KEY (changed_by)
