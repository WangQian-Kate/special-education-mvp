...
主键：`version`。当前保存 `2.0.0`、`2.1.0` 和 `2.2.0`。
...
- 数据库结构与版本 `2.2.0` 一致：18 张表、82 个字段、3 名白名单教师、6 名学生和 165 项标准训练目标。
