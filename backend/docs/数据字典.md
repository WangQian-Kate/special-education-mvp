...
| 项目 | 实测值 |
|---|---|
| 快照时间 | `2026-07-21 15:50:41`（Asia/Shanghai） |
| MySQL | `8.0.45 MySQL Community Server - GPL` |
| 数据库 | `special_ed_assistant` |
| 当前结构版本 | `2.3.0` |
| 已应用版本 | `2.0.0`、`2.1.0`、`2.2.0`、`2.3.0` |
| 默认字符集 | `utf8mb4` |
...
主键：`version`。当前保存 `2.0.0`、`2.1.0`、`2.2.0` 和 `2.3.0`。
...
- 数据库结构与版本 `2.3.0` 一致：18 张表、82 个字段、3 名白名单教师、6 名学生、9 项辅助方式和 165 项标准训练目标。
