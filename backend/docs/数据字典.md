...
主键：`version`。当前保存 `2.0.0`、`2.1.0`、`2.2.0`、`2.3.0`、`2.4.0` 和 `2.5.0`。
...
- 数据库结构与版本 `2.5.0` 一致：18 张表、82 个字段、3 名白名单教师、6 名学生、16 项课程、7 项环境、4 项行为功能、9 项辅助方式和 165 项标准训练目标。
